...
var ChannelService = (function () {
    function ChannelService(window, channelConfig) {
        ...
        this.syncSubject = new Subject_1.Subject();
        ...
        this.syncSubject$ = this.syncSubject.asObservable();
        ...
        this.hubProxy.on("onSelectFood", function (ev) {
            // This method acts like a broker for incoming messages. We 
            //  check the interal array of subjects to see if one exists
            //  for the channel this came in on, and then emit the event
            //  on it. Otherwise we ignore the message.
        ...
        this.hubProxy.on("onUnSelectFood", function (ev) {
            // This method acts like a broker for incoming messages. We 
            //  check the interal array of subjects to see if one exists
            //  for the channel this came in on, and then emit the event
            //  on it. Otherwise we ignore the message.
        ...
        this.hubProxy.on("syncSelectedFoods", function (ev) {
            var selectedFoods = ev.Data;
            _this.syncSubject.next(selectedFoods);
        });
    }
    /**
    ...
    ChannelService.prototype.selectFood = function (food, group) {
        this.hubProxy.invoke("selectFood", food, group);
    };
    ChannelService.prototype.unSelectFood = function (food, group) {
        this.hubProxy.invoke("unSelectFood", food, group);
    };
    ChannelService.prototype.clear = function (channel) {
        this.hubProxy.invoke("clear", channel);
    };
    ChannelService.prototype.disconnect = function () {
