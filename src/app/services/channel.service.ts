...
export class ChannelService {
    ...
    constructor(
        ...
        @Inject("channel.config") private channelConfig: ChannelConfig
         ...
         console.log(this.window);
          ...
          //this.window.$ = $;
           console.log('-------------------------------------'); 
           console.log(this.window.$);
           console.log(this.window.$.hubConnection);
        ...
        this.hubProxy.on("onSelectFood", (ev: ChannelEvent) => {
        ...
        this.hubProxy.on("onUnSelectFood", (ev: ChannelEvent) => {
        ...
        this.hubProxy.on("syncSelectedFoods", (ev: ChannelEvent) => {

            let selectedFoods = ev.Data as Food[];
            this.syncSubject.next(selectedFoods);
        });
    }
    ...
    selectFood(food: Food, group: string) {
        this.hubProxy.invoke("selectFood", food, group);
    }

    unSelectFood(food: Food, group: string) {
